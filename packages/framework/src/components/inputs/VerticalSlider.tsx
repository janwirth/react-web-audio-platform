...
export function VerticalSlider({
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      {label && (
        <span className=" text-xs text-gray-300 dark:text-gray-700 font-mono font-bold rotate-90 mb-2 w-1 scale-75">
          {label}
        </span>
      )}
      <div
        ref={barRef}
        className="relative w-2.5 bg-gray-300 dark:bg-gray-800 rounded-sm cursor-pointer select-none overflow-hidden"
